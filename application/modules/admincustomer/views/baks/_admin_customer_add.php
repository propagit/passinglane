<div class="span9">
	...
	<div style="min-height: 365px; border: 1px solid #d6d6d6; border-radius: 5px; margin-right: 19px;">
		...
		<div style="padding: 20px">
			...
			<form method="post" action="<?=base_url()?>admin/customer/create" autocomplete="off">

			<input type="hidden" name="shipping_same" id="shipping_same" value="1" />
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="firstname" id="firstname" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="lastname" id="lastname" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="email" value="" required/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="phone" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="mobile" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="address" id="address" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="address2" id="address2" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="suburb" id="suburb" value=""/>
			...
			<div>
				...
				<div style="width: 80%; float: right">
					...
					<input style="width: 97%" type="text" class="textfield rounded" name="postcode" id="postcode" value=""/>
