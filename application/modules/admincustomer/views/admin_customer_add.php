...
<div class="row row-bottom-margin">
	<div class="col-md-12">
		<div class="title-page">ADD NEW CUSTOMER</div>
		...
		<form enctype="multipart/form-data" method="post" action="<?=base_url()?>admin/customer/create" autocomplete="off" id="customer-admin-add">
		<div class="row">
			<div class="col-md-10">
					...
					<div>
						...
						<div class="form-common-input">
							<input type="text" class="form-control input-text" id="firstname" name="firstname" data="required"/>
						</div>
					</div>
					...
					<div>
						...
						<div class="form-common-input">
							<input type="text" class="form-control input-text" id="lastname" name="lastname" data="required"/>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
					...
					<div>
						...
						<div class="form-common-input">
							<input onkeyup="copy_email_to_username();" onclick="copy_email_to_username();" onblur="copy_email_to_username();" type="text" class="form-control input-text" id="email" name="email" data="email"/>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
					<div>
						...
						<div class="form-common-input">
							<input type="text" class="form-control input-text" id="phone" name="phone"/>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
					<div>
						...
						<div class="form-common-input">
							<input type="text" class="form-control input-text" id="mobile" name="mobile"/>
						</div>
					</div>
		            <div class="form-common-gap">&nbsp;</div>
					...
					<div>
						...
						<div class="form-common-input">
							<input type="text" class="form-control input-text" id="address2" name="address2"/>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
					<div>
						...
						<div class="form-common-input">
							...
							<input class="pc_txt form-control input-text" type="text" id="search_state" name="search_state" onblur="if(this.value==''){this.value='enter state';}" onfocus="if (this.value=='enter state'){this.value='';} lookup.load_state();" onclick="if (this.value=='enter state'){this.value='';}" value="enter state" onkeyup="lookup.load_state();" />
					...
					<div>
						...
						<div class="form-common-input">
							<input name="country" id="country" type="hidden" value="13">
							<input class="pc_txt form-control input-text" type="text" id="search_country" name="search_country" onblur="if(this.value==''){this.value='Australia';}" onfocus="if (this.value=='Australia'){this.value='';} lookup.load_country();" onclick="if (this.value=='Australia'){this.value='';}" value="Australia" onkeyup="lookup.load_country();" />
					...
					<div>
						...
						<div class="form-common-input">
							<input readonly="readonly" type="text" class="form-control input-text" id="postcode" name="postcode"/>
						</div>
					</div>
		            <div class="form-common-gap">&nbsp;</div>
					...
					<div>
						...
						<div class="form-common-input" style="line-height: 30px;">
							<span id="email-copy">admin@email.com</span>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
					<div>
					...
					<div>
						...
						<div class="form-common-input">
							<button class="btn btn-info" type="button" onclick="help.validate_form('customer-admin-add');"><i class="fa fa-save"></i> Save</button>
						</div>
					</div>
					<div class="form-common-gap">&nbsp;</div>
			...
			<div class="col-md-2">
				...
				<div id="profile-image-upload-wrapper">
                    ...
                    <span class="fileupload-preview" style=" margin : 0px; padding: 5px; padding-top: 0px; text-align: center; width: 100%; margin-bottom:5px"></span>
				...
				<div>
					...
					<div style="float: left">Filename.jpg</div>
