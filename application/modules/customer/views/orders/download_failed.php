	...
	<div class="content-wrap">
        <div class="inner-content top-padding">
            <div class="col-md-12 remove-gutters customer-purchase-head-wrap push">
             ...
             <div class="col-md-12 push remove-left-gutter top-padding">
                <div class="alert alert-danger" ><i class="fa fa-exclamation-triangle"></i>  
                Uh! Oh! Your download failed.<br />
                
                You can try to download the product again by visiting your orders portal. <br />
